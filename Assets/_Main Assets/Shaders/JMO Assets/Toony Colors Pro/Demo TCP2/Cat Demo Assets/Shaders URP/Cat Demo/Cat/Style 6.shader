...
Shader "Toony Colors Pro 2/Examples URP/Cat Demo/Cat/Style 6"
{
	Properties
	{
		...
		_OutlineColorVertex ("Color", Color) = (0,0,0,1)
		 _OutlineColorVertex1 ("Outline Color Vertex", Color) = (1,1,1,1)
		// Outline Normals
	...
	SubShader
	{
		...
		v2f_outline vertex_outline (appdata_outline v)
		{
			...
			float4 __outlineColorVertex = ( _OutlineColorVertex.rgba * _OutlineColorVertex1.rgba );
